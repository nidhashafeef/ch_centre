...
class BloodGroupAdapter(val context: Context, private val bloodGroups: List<BloodGroupModels>) : RecyclerView.Adapter<BloodGroupAdapter .MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.list_view_bloodgroups, parent, false)
