...
class PhoneAuthentication : AppCompatActivity() {
    ...
    private fun verificationCallbacks () {
        mCallbacks = object: PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onVerificationFailed(ee: FirebaseException?) {
                Log.e("Firebase",ee?.stackTrace.toString())
                Toast.makeText(applicationContext,"failed: "+ee?.localizedMessage,Toast.LENGTH_SHORT).show()
            }
    ...
    private fun verify () {
        ...
        val phnNo = "+91"+phnNoTxt.text.toString()
